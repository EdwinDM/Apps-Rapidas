...
function my_theme_scripts() {
    ...
    wp_enqueue_script('slickNavStyles', get_stylesheet_directory_uri(). '/scripts/my_script.js', array('slickNavScript'), '1.0.0', false);
}
...
function my_theme_logo_setup() {
    ...
    add_theme_support('custon-logo', $defaults);
}
